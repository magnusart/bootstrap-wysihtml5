	...
	var templates = {
		...
		"link": 	"<li>" 
						...
						+ "<div class='bootstrap-wysihtml5-insert-link-modal modal hide fade'>"
							...
							+ "<a class='close' data-dismiss='bootstrap-wysihtml5-insert-link-modal'>×</a>"
							  + "<h3>Insert Link</h3>"
							+ "</div>"
							...
							+ "<div class='modal-footer'>"
							  + "<a href='#' class='btn' data-dismiss='bootstrap-wysihtml5-insert-link-modal'>Cancel</a>"
			...
			"image": "<li>" 
						...
						+ "<div class='bootstrap-wysihtml5-insert-image-modal modal hide fade'>"
							+ "<div class='modal-header'>"
							+ "<a class='close' data-dismiss='bootstrap-wysihtml5-insert-image-modal'>×</a>"
							  + "<h3>Insert Image</h3>"
							+ "</div>"
							+ "<div class='modal-body'>"
							...
							+ "</div>"
							+ "<div class='modal-footer'>"
							  + "<a href='#' class='btn' data-dismiss='bootstrap-wysihtml5-insert-image-modal'>Cancel</a>"
